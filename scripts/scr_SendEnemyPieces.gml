...
buffer_write(buff, buffer_s16, PIECES_POSITION);
for (var i = 0; i < 16; i++){
    buffer_write(buff, buffer_u16, global.enemy_pieces[i].x);
    buffer_write(buff, buffer_u16, global.enemy_pieces[i].y);
    buffer_write(buff, buffer_bool, global.enemy_pieces[i].moving);
